...
extern APTR  ECALL_ObtainTableSegment(struct ProcessorIFace *IFace, ULONG flags);
extern APTR  ECALL_ReleaseTableSegment(struct ProcessorIFace *IFace, APTR handle);
extern APTR  ECALL_GetTableSegmentAttr(struct ProcessorIFace *IFace, APTR handle, APTR key);
extern APTR  ECALL_SetTableSegmentAttr(struct ProcessorIFace *IFace, APTR handle, APTR key);
...
extern BPTR	 ObtainPolymorphSegment(struct LIBRARY_CLASS *Self,APTR name);
