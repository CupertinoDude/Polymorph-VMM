...
#include <interfaces/polymorphclass.h>
/*
\\	"Polymorph" Developer Materials
*/

#define LIBRARY_NAME		"javavm.datatype"
#define LIBRARY_IDENTITY	"Polymorph::JavaVM v1.0"
...
extern CONST APTR LibEprocTableA[];
